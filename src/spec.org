...
*** Account Address
    ...
    - Type /SlideData/ denotes a binary blob encoded in a tree data structure.
    - Type /i32/ is a 32-bit integer.
...
*** Account Storage
    ...
    \\
    \\
    - Type /Grams/ is a set of natural numbers in the range $\{0 ... 2^{256}\}$,
      equipped with $+$ and $-$ operators, such that
      $$a - b = 0 \iff b >= a$$
...
*** Events
   ...
   - The destination address /dst/ may contain any identifier. It is included
     for easier integration with off-chain applications, i.e. they could monitor
     emitted events based on their destination address.
...
*** Executor Types
    ...
    For each type of messages, there exists a separate Executor.
    In this  work, we  consider only  the OrdinaryTransactionExecutor,
    that is  defined in
    [[https://github.com/tonlabs/ton-labs-executor/blob/a28bde3e65dd35573d34e32aa4477d60162b5338/src/ordinary_transaction.rs][orderinary_transaction.rs]].
