...
**** Smart-Contract Storage (StateInit)
    ...
    - /library/ encodes the  code libraries the contract  may refer to
      its code. Current status of this the library feature is unclear.
...
**** Data Storage Fee Calculation
    ...
    To simplify  the calculation form,  let us introduce a new list
    $Pr'$, such that:
