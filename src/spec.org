...
*** External Message
   ...
   | <15>                     | <15>                                                                                                                                                                                                                               |
   | [[file:./img/excl2.png]] | The field /import_fee/ should have been the value paid to the validator for processing an external message. But in the current node, this field is not used. Hence, the fee is not paid. We reported this issue to the developers.  |
...
*** Transaction Description Object
    ...
    | bounce_ph    | [[bounce_phase_descriptor][Bounce phase descriptor]]   |
