...
** Document Structure
   ...
   data structures used through-out  the Transaction Executor. The data structures
   ...
   relevant  to  the Transaction Executor,  requiring  much  wider context  to  be
   explained.
...
*** Account Address
    ...
    structure is called an /account address/.
...
**** Account State
     ...
     the message being executed for that account. The Transaction Executor logic vary
...
** Messages
   <<messages>>
   Messages are the main mechanism of communication between non-blockchain
   applications and smart-contracts.

   Technically, a message is a data structure encoding one of the following:
   - desired function call at a destination  smart-contract,  optionally including some  coins, attached to the call.
